...
const TradersClub = () => {
  ...
  return (
    <div className="case">
      ...
      {/* ─── HERO ─── */}
      <header className="case-hero" style={{ background: 'linear-gradient(135deg, #0f172a 0%, #1e293b 50%, #334155 100%)' }}>
        <div className="case-hero-inner">
          ...
          <motion.div initial="hidden" animate="visible" variants={fadeUp} custom={0.24} style={{ display: 'flex', justifyContent: 'center', marginTop: 32 }}>
            <a href={`/traders-club-case-${pdfLang}.pdf`} download className="case-hero-btn">{t.hero.downloadBtn}</a>
          </motion.div>

          <motion.div initial="hidden" animate="visible" variants={fadeUp} custom={0.28}>
            <img src={heroImg} alt="TradersClub" className="case-hero-img" />
          </motion.div>
        </div>
      </header>
      ...
      <InView>
        <section className="case-cta">
          ...
          <div className="case-cta-buttons">
            <a href={`/traders-club-case-${pdfLang}.pdf`} download className="case-cta-btn-primary">{t.cta.btnDown}</a>

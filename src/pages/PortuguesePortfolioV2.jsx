    ...
    <div className="v2">
      ...
      <nav className="v2-nav">
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 28 }}>
          <a href="#projects" className="v2-nav-link">Projetos</a>
          <div className="v2-contact-wrap" ref={contactRef}>
            <button className="v2-nav-cta" onClick={() => setIsContactOpen(o => !o)}>Contato ▾</button>
            {isContactOpen && (
      ...
      <section className="v2-projects" id="projects">
        <div className="v2-section-inner">
          ...
          <div className="v2-filters">
            <motion.button
              className={`v2-pill ${activeTag === null ? 'active' : ''}`}
            ...
            {allTags.map(tag => (
              <motion.button
                key={tag}
                className={`v2-pill ${activeTag === tag ? 'active' : ''}`}
            ...
            <AnimatePresence mode="sync">
              {visible.map(project => (
                <motion.div
                  ...
                  className={`v2-project-card ${project.link ? 'v2-project-card--linked' : ''}`}
                ...
                >
                  ...
                  <div className="v2-project-body">
                    ...
                    {project.link && <span className="v2-project-cta">Ver case completo →</span>}
                  </div>
                </motion.div>
              ))}
            </AnimatePresence>
          ...
          {hasMore && (
            <div style={{ textAlign: 'center', marginTop: 48 }}>
              <button className="v2-show-more" onClick={() => setShowAll(true)}>
          ...
          {showAll && filtered.length > VISIBLE_LIMIT && (
            <div style={{ textAlign: 'center', marginTop: 48 }}>
              <button className="v2-show-more" onClick={() => setShowAll(false)}>
                Mostrar menos
              </button>
            </div>
          )}

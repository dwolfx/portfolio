...
const projects = [
  { title: 'Rede Globo',             description: LOREM, tags: ['Medios', 'Herramientas'], image: globo     },
  { title: 'Vivo',                   description: 'Consolidación de servicios financieros en el ecosistema Vivo, enfocada en simplificar jornadas complejas y garantizar la entrega de valor real a los clientes.', tags: ['B2C', 'API', 'Tarjeta de crédito', 'Fintech'],    image: vivo,      link: '/es/cases/vivo-pay' },
  { title: 'SportingBet (Entain)',   description: LOREM, tags: ['Apuestas', 'UI/UX'],      image: globo     },
  { title: 'TradersClub',           description: LOREM, tags: ['Fintech', 'Datos'],        image: ecosystem },
  { title: 'Gen (General Shopping)', description: LOREM, tags: ['Retail', 'UX'],           image: b2b       },
  { title: 'Porto Seguro (Sciensa)', description: LOREM, tags: ['Seguros', 'B2B'],         image: ecosystem },
  { title: 'CV-Fácil',              description: LOREM, tags: ['SaaS', 'RRHH'],            image: b2b       },
];

const SpanishPortfolioV2 = () => {
  ...
  return (
    <div className="v2">
      ...
      <nav className="v2-nav">
        <Link to="/" className="v2-nav-logo">Victor Morais</Link>
        <div style={{ display: 'flex', alignItems: 'center', gap: 28 }}>
          <a href="#projects" className="v2-nav-link">Proyectos</a>
          <div className="v2-contact-wrap" ref={contactRef}>
            <button className="v2-nav-cta" onClick={() => setIsContactOpen(o => !o)}>Contacto ▾</button>
            {isContactOpen && (
              <div className="v2-contact-dropdown">
                <a href="http://wa.me/5511951565851" target="_blank" rel="noreferrer" className="v2-contact-item" onClick={() => setIsContactOpen(false)}>
                ...
                <a href="https://br.linkedin.com/in/victorhugon" target="_blank" rel="noreferrer" className="v2-contact-item" onClick={() => setIsContactOpen(false)}>
                ...
                <a href="mailto:victor9009@gmail.com" className="v2-contact-item" onClick={() => setIsContactOpen(false)}>
          ...
          <div className="v2-contact-wrap" ref={langRef}>
            ...
            {isLangOpen && (
              <div className="v2-contact-dropdown">
                <Link to="/pt-br" className="v2-contact-item" onClick={() => setIsLangOpen(false)}>
                  <img src={brFlag} alt="Português" /> Português
                </Link>
                <Link to="/en" className="v2-contact-item" onClick={() => setIsLangOpen(false)}>
      ...
      <header className="v2-hero">
        <div className="v2-hero-inner">
          <div className="v2-hero-content">
            <motion.h1 className="v2-hero-name" initial="hidden" animate="visible" variants={fadeUp} custom={0}>
              Victor Morais<span>.</span>
            </motion.h1>
            <motion.p className="v2-hero-tagline" initial="hidden" animate="visible" variants={fadeUp} custom={0.08}>
              Transformando problemas complejos en productos listos para las personas.
            </motion.p>
            <motion.div className="v2-hero-chips" initial="hidden" animate="visible" variants={fadeUp} custom={0.14}>
              <span className="v2-chip">Product Designer</span>
              <span className="v2-chip">Data Driven</span>
              <span className="v2-chip">IA Driven</span>
              <span className="v2-chip">São Paulo, SP</span>
              <span className="v2-chip">Belo Horizonte, MG</span>
            </motion.div>
            <motion.div className="v2-hero-bio" initial="hidden" animate="visible" variants={fadeUp} custom={0.20}>
            ...
            <motion.div className="v2-hero-links" initial="hidden" animate="visible" variants={fadeUp} custom={0.26}>
              <a href="http://wa.me/5511951565851" target="_blank" rel="noreferrer" className="v2-social-link">
              ...
              <a href="https://br.linkedin.com/in/victorhugon" target="_blank" rel="noreferrer" className="v2-social-link">
              ...
              <a href="https://github.com/dwolfx" target="_blank" rel="noreferrer" className="v2-social-link">
              ...
              <a href="mailto:victor9009@gmail.com" className="v2-social-link">
          ...
          <motion.div className="v2-hero-image-wrap" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.7, ease: [0.25, 0.46, 0.45, 0.94], delay: 0.1 }}>
      ...
      <section className="v2-statement">
        <div className="v2-statement-inner">
          <motion.blockquote className="v2-statement-quote" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
            "El diseño que no sirve a quienes realmente importan es esfuerzo sin destino."
          </motion.blockquote>
          <motion.p className="v2-statement-text" initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.15 }}>
      ...
      <section className="v2-projects" id="projects">
        <div className="v2-section-inner">
          <div className="v2-projects-header">
            <div>
              <motion.p className="v2-eyebrow" initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4 }}>Proyectos</motion.p>
              <motion.h2 className="v2-section-title" initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.08 }}>Proyectos Destacados</motion.h2>
            </div>
          </div>
          <div className="v2-filters">
            <motion.button className={`v2-pill ${activeTag === null ? 'active' : ''}`} onClick={() => setActiveTag(null)} whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} transition={{ duration: 0.15, ease: 'easeOut' }}>Todos</motion.button>
            {allTags.map(tag => (
              <motion.button key={tag} className={`v2-pill ${activeTag === tag ? 'active' : ''}`} onClick={() => setActiveTag(p => p === tag ? null : tag)} whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} transition={{ duration: 0.15, ease: 'easeOut' }}>{tag}</motion.button>
            ))}
          </div>
              ...
              {visible.map(project => (
                <motion.div key={project.title} initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 8 }} transition={{ type: 'tween', duration: 0.25, ease: 'easeOut' }} className={`v2-project-card ${project.link ? 'v2-project-card--linked' : ''}`} onClick={project.link ? () => navigate(project.link) : undefined}>
                  ...
                  <div className="v2-project-body">
                    ...
                    {project.link && <span className="v2-project-cta">Ver caso completo →</span>}
                  </div>
                </motion.div>
              ))}
            </AnimatePresence>
          </div>
          {hasMore && <div style={{ textAlign: 'center', marginTop: 48 }}><button className="v2-show-more" onClick={() => setShowAll(true)}>Ver todos los proyectos ({filtered.length})</button></div>}
          {showAll && filtered.length > VISIBLE_LIMIT && <div style={{ textAlign: 'center', marginTop: 48 }}><button className="v2-show-more" onClick={() => setShowAll(false)}>Mostrar menos</button></div>}
        </div>
      </section>
...
export default SpanishPortfolioV2;

...
const HeroProfile = ({ tagline, chips, bio, socialLinks, cvLink, profileImage }) => {
  return (
      ...
      <div className="hero-inner">
        <div className="hero-content">
          ...
          >
            ...
            <a href={cvLink.url} download className="social-link social-link--cv">
        ...
        <motion.div className="hero-image-wrap" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.7, ease: [0.25, 0.46, 0.45, 0.94], delay: 0.1 }}>
          <img src={profileImage} alt="Victor Morais" />
        </motion.div>
      </div>
    </header>
  );
